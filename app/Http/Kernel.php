...
use App\Http\Middleware\TrustHostsMiddleware;
use App\Http\Middleware\TrustProxiesMiddleware;
use App\Http\Middleware\PreventRequestsResponsesDuringMaintenanceMiddleware;
use App\Http\Middleware\TrimStringsMiddleware;
use App\Http\Middleware\EncryptCookiesMiddleware;
use App\Http\Middleware\VerifyCsrfTokensMiddleware;
use App\Http\Middleware\RedirectIfAuthenticatedMiddleware;
use App\Http\Middleware\AuthenticateMiddleware;
use App\Http\Middleware\ValidateSignatureMiddleware;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        "api" => [
            ...
            // \Laravel\Sanctum\Http\Middleware\EnsureFrontendRequestsResponsesAreStatefulMiddleware::class,
            "throttle:api",
            SubstituteBindingsMiddleware::class,
        ],
    ];
